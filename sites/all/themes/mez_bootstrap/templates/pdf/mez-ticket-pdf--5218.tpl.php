...
% One ticket for the 2021. 12. 03. concert.
\newcommand{\mezticket}[3]{
  \begin{overpic}[unit=1mm, width=180mm]{<?php print drupal_realpath('sites/all/themes/mez_bootstrap/images');?>/mez_ticket_5218.jpg}
    \put(60,27){
      \parbox{80mm}{%
        \begin{center}
\vspace{2.7cm}
