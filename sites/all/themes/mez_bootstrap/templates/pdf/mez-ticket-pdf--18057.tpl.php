...
\node[anchor=north, align=center] at (13,6.9) {
	...
	2022. december 3. szombat 16:30\vspace{3mm}\\
...
<?php foreach ($tickets as $ticket) :?>
 \mezticket{<?php print ucfirst($ticket['seat']) ?>}{<?php print $ticket['price']?> Ft}{<?php print str_pad($ticket['id'], 8, '0', STR_PAD_LEFT); ?>}{<?php print format_date($order->placed, 'short', '', NULL, 'hu');?>}
<?php endforeach;?>
